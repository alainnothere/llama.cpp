...
ggml_tensor * llama_model_qwen4exp::graph::build_qsa_top_k(
    ...
    // argsort + view, not ggml_top_k: the Vulkan top_k pipelines cap k at 1023 (BLOCK_SIZE <= 1024)
    // and the indexer asks for more than that. the extra ordering is irrelevant - the indices only
    // feed ggml_set_rows below
