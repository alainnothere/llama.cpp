...
| `--performance-instrumentation, --no-performance-instrumentation` | print a 5s timing breakdown of decode()/synchronize() (libllama) and of update_slots() (server) (default: false)<br/>(env: LLAMA_ARG_PERF_INSTRUMENTATION) |
